	...
	public function __construct( &$polylang ) {
		...
		parent::__construct(
			...
			array(
				...
				'description'   => __( 'When the front page is visited, redirects to the homepage in the browser preferred language. As this doesn\'t work if the front page is cached, we will attempt to disable the front page cache for known cache plugins.', 'polylang' ),
