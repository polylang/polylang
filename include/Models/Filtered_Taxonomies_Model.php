 ...
 * @since 3.7
 */
class Filtered_Taxonomies_Model {
	/**
	 * Return taxonomies that need to be filtered (post_format like).
	 *
	 * @since 1.7
	 * @since 3.7 Moved from `PLL_Model::get_filtered_taxonomies()` to `WP_Syntex\Polylang\Models\Filtered_Taxonomies_Model::get_filtered_taxonomies()`.
	 *
	 ...
	 *
	 * @since 1.7
	 * @since 3.7 Moved from `PLL_Model::is_filtered_taxonomy()` to `WP_Syntex\Polylang\Models\Filtered_Taxonomies_Model::is_filtered_taxonomy()`.
	 *
	 ...
	 *
	 * @since 1.7
	 * @since 3.7 Moved from `PLL_Model::get_filtered_taxonomies_query_vars()` to `WP_Syntex\Polylang\Models\Filtered_Taxonomies_Model::get_query_vars()`.
	 *
	 * @return string[]
	 */
