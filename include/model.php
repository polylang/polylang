 ...
 * @method string[]           get_filtered_taxonomies(bool $filter = true)
 * @method bool               is_filtered_taxonomy(string|string[] $tax)
 * @method string[]           get_filtered_taxonomies_query_vars()
 */
class PLL_Model {
	/**
	 ...
	 *
	 * @var Models\Languages_List_Model
	 */
	public $languages_list_model;
	...
	public function __call( string $name, array $arguments ) {
		$methods = array(
			'has_languages'                      => array( $this->languages_list_model, 'has_languages' ),
			'get_languages_list'                 => array( $this->languages_list_model, 'get_languages_list' ),
			'are_languages_ready'                => array( $this->languages_list_model, 'are_languages_ready' ),
			'set_languages_ready'                => array( $this->languages_list_model, 'set_languages_ready' ),
			'filter_language_terms_orderby'      => array( $this->languages_list_model, 'filter_language_terms_orderby' ),
	 ...
	 */
	public function get_translated_post_types( bool $filter = true ): array {
	 ...
	 * @return bool
	 */
	public function is_translated_post_type( $post_type ): bool {
	 ...
	 */
	public function get_translated_taxonomies( bool $filter = true ): array {
	 ...
	 * @return bool
	 */
	public function is_translated_taxonomy( $tax ): bool {
	...
	public function count_posts( PLL_Language $lang, array $q = array() ): int {
		...
		if ( ! is_array( $counts ) ) {
			...
			$where  .= $this->post->where_clause( $this->languages_list_model->get_languages_list() );
