...
class PLL_Wizard {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'polylang_admin', plugins_url( '/build/admin' . $this->get_suffix() . '.css', POLYLANG_ROOT_FILE ), array(), POLYLANG_VERSION );
		wp_enqueue_style( 'pll-wizard', plugins_url( '/build/wizard' . $this->get_suffix() . '.css', POLYLANG_ROOT_FILE ), array( 'dashicons', 'install', 'common', 'forms' ), POLYLANG_VERSION );
	...
	public function add_step_licenses( $steps ) {
		...
		wp_enqueue_script( 'pll_admin', plugins_url( '/build/admin' . $this->get_suffix() . '.js', POLYLANG_ROOT_FILE ), array( 'jquery' ), POLYLANG_VERSION, true );
	...
	public function add_step_languages( $steps ) {
		...
		wp_enqueue_script( 'pll_admin', plugins_url( '/build/admin' . $this->get_suffix() . '.js', POLYLANG_ROOT_FILE ), array( 'jquery', 'jquery-ui-selectmenu' ), POLYLANG_VERSION, true );
		wp_localize_script( 'pll_admin', 'pll_admin', array( 'dismiss_notice' => esc_html__( 'Dismiss this notice.', 'polylang' ) ) );
		wp_localize_script(
		...
		wp_enqueue_style( 'pll-wizard-selectmenu', plugins_url( '/build/admin' . $this->get_suffix() . '.css', POLYLANG_ROOT_FILE ), array( 'dashicons', 'install', 'common', 'wp-jquery-ui-dialog' ), POLYLANG_VERSION );
	...
	public function add_step_untranslated_contents( $steps ) {
		if ( ! $this->model->has_languages() || $this->model->get_objects_with_no_lang( 1 ) ) {
			...
			wp_enqueue_script( 'pll_admin', plugins_url( '/build/admin' . $this->get_suffix() . '.js', POLYLANG_ROOT_FILE ), array( 'jquery', 'jquery-ui-selectmenu' ), POLYLANG_VERSION, true );
			wp_localize_script( 'pll_admin', 'pll_admin', array( 'dismiss_notice' => esc_html__( 'Dismiss this notice.', 'polylang' ) ) );
			wp_enqueue_style( 'pll-wizard-selectmenu', plugins_url( '/build/admin' . $this->get_suffix() . '.css', POLYLANG_ROOT_FILE ), array( 'dashicons', 'install', 'common' ), POLYLANG_VERSION );
