	...
	<div class="documentation-container">
		<p class="pll-wizard-actions step documentation-button-container">
			<a
				...
				href="<?php echo esc_url( 'https://polylang.pro/documentation/support/getting-started/' ); ?>"
				target="blank"
			>
...
<ul class="pll-wizard-next-steps">
	<li class="pll-wizard-next-step-item">
		...
		<div class="pll-wizard-next-step-action">
			<p class="pll-wizard-actions step">
				<a class="button button-primary button-large" href="<?php echo esc_url( 'https://polylang.pro/documentation/support/getting-started/create-menus/' ); ?>">
					<?php esc_html_e( 'Read documentation', 'polylang' ); ?>
				</a>
			</p>
		</div>
	...
	<?php if ( ! defined( 'POLYLANG_PRO' ) && ! defined( 'WOOCOMMERCE_VERSION' ) ) : ?>
		<li class="pll-wizard-next-step-item">
			...
			<div class="pll-wizard-next-step-action">
				<p class="pll-wizard-actions step">
					<a class="button button-primary button-large" href="<?php echo esc_url( 'https://polylang.pro/pricing/polylang-pro/' ); ?>">
	...
	<?php if ( ! defined( 'POLYLANG_PRO' ) && defined( 'WOOCOMMERCE_VERSION' ) && ! defined( 'PLLWC_VERSION' ) ) : ?>
		<li class="pll-wizard-next-step-item">
			...
			<div class="pll-wizard-next-step-action">
				<p class="pll-wizard-actions step">
					<a class="button button-primary button-large" href="<?php echo esc_url( 'https://polylang.pro/pricing/polylang-for-woocommerce/' ); ?>">
						<?php esc_html_e( 'Buy now', 'polylang' ); ?>
					</a>
				</p>
			</div>
