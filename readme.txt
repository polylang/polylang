...
* Machine translation with DeepL (Doesn't work with Elementor).
...
1. Make sure you are using WordPress 6.5 or later and that your server is running PHP 7.2 or later (same requirement as WordPress itself).
