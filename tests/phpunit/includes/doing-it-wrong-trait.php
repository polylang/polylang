...
trait PLL_Doing_It_Wrong_Trait {
	/**
	 * Don't trigger an error if `WP_Syntex\Polylang\Models\Languages_List_Model::get_languages_list()` is called too early.
	 ...
	 * - `WP_Syntex\Polylang\Models\Language_Model::add()` =>
	 * - `WP_Syntex\Polylang\Models\Language_Model::validate_lang()` =>
	 * - `WP_Syntex\Polylang\Models\Languages_List_Model::get_languages_list()`.
	...
	public function doing_it_wrong_run( $function, $message = '', $version = '' ) {
		if ( 'WP_Syntex\Polylang\Models\Languages_List_Model::get_languages_list()' === $function ) {
			return;
		}
