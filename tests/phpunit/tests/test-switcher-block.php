...
class Switcher_Block_Test extends PLL_UnitTestCase {
	...
	public function test_switcher_block_list_is_wrapped_in_nav_tag() {
		...
		$this->assertSameSets(
			array( 'pll-switcher', 'pll-layout-vertical', 'pll-alignment-left', 'wp-block-polylang-language-switcher' ),
	...
	public function test_custom_class_dropdown_switcher_block() {
		...
		$this->assertSameSets(
			array( 'pll-switcher', 'test-class', 'pll-layout-select', 'pll-alignment-left', 'wp-block-polylang-language-switcher' ),
