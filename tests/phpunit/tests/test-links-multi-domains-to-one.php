...
class Links_Multi_Domains_To_One_Test extends PLL_UnitTestCase {
	 ...
	 *           [false, false]
	 */
	public function test_filtered_home_and_search_urls( $cache_languages, $cache_home_url ) {
		$this->mock_constants(
			array(
	 ...
	 *           [null, null]
	 */
	public function test_raw_home_and_search_urls( $cache_languages, $cache_home_url ) {
		$this->mock_constants(
			array(
				'PLL_CACHE_LANGUAGES' => $cache_languages,
				'PLL_CACHE_HOME_URL'  => $cache_home_url,
